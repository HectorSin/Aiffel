...
# [200~마크 저커버그가 직접 만들어 본 AI 비서 ‘자비스’]
2016년 12월 19일
...
현재 **앤드류 응 교수**는 회원 수 1억 1800만 명 규모의 온라인 공개 수업 플랫폼 코세라(Coursera)를 창립하고 이끌고 있으며, 스탠퍼드 대학 컴퓨터과학 및 전기공학과 겸임교수를 지내고 있다. 또한 1억 7000만 달러 규모의 자금을 운용하는 AI 펀드의 핵심 투자자 중 한명이다. 전 세계 AI 4대 석학이자 산업, 투자의 중심에 있는 앤드류 응 교수가 바라보는 AI 세계의 미래는 어떨까?
...
우분투 서버에서 오직 vim 편집기를 사용하여 하나의 마크다운 문서를 편집해본 경험은 처음이라 매우 색달랐습니다.
평소에는 간단하게 블로그를 살펴보면서 썼던 명령어들이 기초부터 차근차근 배울수 있는 경험은 매우 갑집니다.
다양한걸 배울 수 있었던 기회였습니다.
좀더 기록을 세세하게 해서 이 내용들을 블로그를 다시 검색해서가 아닌 제가 정리된 글을 다시 살펴보면서 진행할 수 있도록 해보고 싶습니다.
